...
$plugin->version = 2019030735;                      // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = '1.0.2-35.0'; // Pattern: [major].[minor].[patch]-[Moodle Version].[Moodle version specific patch].
