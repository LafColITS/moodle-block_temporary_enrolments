...
$plugin->version = 2018092733;                      // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = '1.0.1-33.0'; // Pattern: [major].[minor].[patch]-[Moodle Version].[Moodle version specific patch].
$plugin->dependencies = array(
  'local_temporary_enrolments' => 2018092633 // Version 1.0.0-33.0.
);