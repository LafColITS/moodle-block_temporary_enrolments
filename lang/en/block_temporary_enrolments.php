...
$string['warning_instance_level'] = 'Provisional enrolments plugin not enabled, it is required for this block to function.';
$string['warning_admin_level'] = 'WARNING! Provisional enrolments plugin is not enabled. Please enable it for the proper functioning of this block.';
